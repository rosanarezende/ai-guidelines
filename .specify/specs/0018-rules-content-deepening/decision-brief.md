...
> **Nota de execução (2026-05-06):** a implementação de Stage 2 revisititou apenas o eixo de não-determinismo para **N=1 documentado**, apoiado no benchmark externo `[EXT-AKITA-2026]` e registrado em `plan.md` § "Decisões revisitadas". O gate humano original permanece preservado aqui como baseline histórico da decisão.
...
| B     | **A + 1 rodada manual de eval** (single-shot por regra crítica) registrada em `research/2026-05-06-eval-results.md` (novo)          | Provê evidence-base para B08; sinaliza viabilidade          | Custo moderado; resultados single-shot têm reservas (cf. B05)     |
| C     | **A + N rodadas manuais** (vetor de B05 escolhido) registradas em `research/2026-05-06-eval-results.md`                             | Cumpre o que B05 cravar; calibra B08 com rigor              | Custo significativo; pode arrastar prazo da 0018                  |
...
**Status agregado:** `Resolved` (todos os pontos `[DEC-0018-*]` acima foram fechados no gate humano de 2026-05-02; revisitas de execução pós-gate vivem em `plan.md` § "Decisões revisitadas").
