...
2. As regras de texto (como a `CORE-02`) carregam o caminho _hardcoded_ do repositório mãe (`.specify/specs/...`), o que quebra o ciclo num consumidor se o caminho local não for idêntico.
...
Para forçar todas as IAs a convergirem para o `AGENTS.md`, o CLI precisa de um "Trampoline Manager" que crie _hard-redirects_ nos formatos nativos de cada provedor, além de seus respectivos arquivos `.ignore`.
