...
- `.specify/specs/researchs/architecture/2026-04-30-benchmark-rules-content.md` (provedores e OSS curado).
- `.specify/specs/researchs/architecture/2026-04-30-empirical-bugs-ai-code.md` (informa B.1.5).
- `cli/governance/monolith/compiler.mjs` (instrumento da medição).
- `.specify/specs/roadmap/backlog.md` (`regra-hierarquia` em "Now"; pré-requisito 0018 mergeada).
