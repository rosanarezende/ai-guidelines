...
Salve os outputs brutos no diretório centralizado de researches com o padrão:

```
.specify/specs/researchs/governance/2026-05-06-spec-0018-eval-outputs/{PROMPT_ID}_{PROVIDER}_{RUN}.md
```
...
...
eval-outputs/EVAL-03_gemini_run1.md
```
