...
_(Espaço para recomendações finais após validação completa.CLI deve fundir arquivos durante o `spec adopt` ou manter a hierarquia atual baseada no modelo alvo detectado?)_
