...
> Tipo de spec: [evidence-driven | deterministic | mixed] <!-- OBRIGATÓRIO. Sem default — escolha consciente. Ver `docs/process/spec-foundation.md` § "Tipos de spec". -->
...
>
> **Princípios da Escrita:** ver `docs/process/spec-foundation.md` §
