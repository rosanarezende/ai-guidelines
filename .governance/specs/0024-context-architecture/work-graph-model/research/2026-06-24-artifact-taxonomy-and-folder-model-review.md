...
**DEC-0024-G24** foi registrada em `decision-brief.md`: formaliza D7–D11 + a dimensão `disposição`, defere a reorg ampla de pastas e deixa O1/O3/O4 explicitamente abertos. Esta `pre-coding-review` permanece como evidência do raciocínio que precedeu a DEC (lifecycle correto: pre-coding-review → DEC → execução).
