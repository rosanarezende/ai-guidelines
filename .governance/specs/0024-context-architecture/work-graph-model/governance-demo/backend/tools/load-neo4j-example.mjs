...
//     node backend/tools/load-neo4j-example.mjs --apply --source-hash <hash>
...
if (dryRun) {
  ...
  console.log(
    `  apply seguro: node backend/tools/load-neo4j-example.mjs --apply --source-hash ${model.metadata.contentHash}`
  );
  process.exit(0);
}
