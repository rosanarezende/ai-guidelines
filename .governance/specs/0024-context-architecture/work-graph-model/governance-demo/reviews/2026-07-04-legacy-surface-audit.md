...
### Migrar depois, com criterio

A migracao de `.mjs` deve ser por lote funcional, nao por extensao de arquivo:

1. `backend/tools/check-governance-app.mjs`, `check-runtime.mjs`, `test-adversarial.mjs` e
...
de produto; ela apenas deixa claro que a proxima etapa nao e limpeza por delecao, e sim migracao
gradual dos CLIs legados e ampliacao das telas/rotas reais.
