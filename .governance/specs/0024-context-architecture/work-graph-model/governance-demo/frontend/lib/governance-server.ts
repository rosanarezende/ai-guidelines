import { buildGraphReadModel, openFileGovernanceRuntime } from "@demo/backend";
import { readFileSync } from "node:fs";
import path from "node:path";
import {
  loadPublishedRepoContracts,
  validateRepoContracts,
} from "../../backend/tools/repo-contracts.mjs";
import { loadPublishedContexts, validateRepoContexts } from "../../backend/tools/repo-contexts.mjs";
import { loadPublishedRepoWorks, validateRepoWorks } from "../../backend/tools/repo-works.mjs";
