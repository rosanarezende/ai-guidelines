...
declare module "*backend/index.mjs" {
  export * from "@demo/backend";
}

declare module "*backend/tools/repo-contracts.mjs" {
...
declare module "*backend/tools/repo-contexts.mjs" {
...
declare module "*backend/tools/repo-works.mjs" {
