...
| 02    | Selecionar/criar workspace         | `/organizations`              | Criar workspace novo, selecionar workspace existente e anexar demo sem vazar acme.                                                  | create/select/list workspace                  | `iterado`           | `testado-automatizado` | `testado-automatizado`    | APP-02 ativo: signup -> create workspace -> onboarding; settings/console nao vazam demo.                                                                                                                          |
...
| 07    | Onboarding - pessoas e papeis      | `/onboarding`                 | Guiar a pessoa criadora a assumir papeis proprios, enxergar lacunas, convidar responsaveis e abrir gestao avancada quando precisar. | members + roles + invites                     | `iterado`           | `testado-automatizado` | `testado-automatizado`    | APP-07 ativo: authority-guide pergunta quem a pessoa e, registra self-assigned, mostra lacunas, cria convite e mantem gestao avancada/Settings sincronizados. Aceite por pessoa convidada ainda e fluxo dedicado. |
...
| Onboarding - pessoas/papeis    | `authority-guide`     | Explicar quem esta configurando, quais papeis a pessoa assume, o que fica aberto e por que papel para outra pessoa fica `proposed`. | `iterado`     | APP-07 cobre escolha guiada, self-assigned, lacunas, convite e gestao avancada. |
