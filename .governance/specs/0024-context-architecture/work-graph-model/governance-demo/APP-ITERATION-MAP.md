...
| 45    | Auth real + cache escopado         | `/api/auth/[...all]`          | Montar Better Auth via Next.js; adaptar signup/workspace/convite; manter TanStack Query escopado por conta/workspace.          | portal identity + Zod session scope           | `iterado-parcial`   | `testado-automatizado` | `testado-automatizado`    | APP-45 ativo: signup Better Auth -> bridge local -> workspace -> convite -> signup da pessoa convidada -> accept; cache fino segue em APP-46 expected-fail. |
