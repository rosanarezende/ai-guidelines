...
| 03A   | Navegacao global                   | shell/app header              | Implementar topbar + sidebar/drawer, itens, subitens, estados e acesso ao console/Cup.            | shell implementado; APP-35 active             | `iterado`     | `nao-validado-visual`  | `testado`                 | Falta validacao visual humana; authority fino fica para APP-07/APP-16.                   |
