...
| 07    | Onboarding - pessoas e papeis      | `/onboarding`                 | Trabalhar por pessoas/times/grupos recebendo papeis, com aceite quando outro sujeito e atribuido. | members + roles + invites                     | `nao-iterado` | `nao-validado-visual`  | `nao-testado`             | Mecanismo e UI de Settings ativos por APP-07/16; falta validar a etapa visual do onboarding.          |
