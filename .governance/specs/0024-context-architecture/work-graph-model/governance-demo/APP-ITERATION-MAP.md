...
| 03A   | Navegacao global                   | shell/app header              | Decidir e validar barra/menu, itens, subitens, agrupamento por fluxo e acesso ao console/Cup.     | QRD-35 pendente                               | `nao-iterado` | `nao-validado-visual` | `nao-testado`             | Decisao obrigatoria antes de fechar APP-02 como experiencia final. |
...
3. QRD-35 de navegacao global: barra/menu, itens e subitens, agrupamento por fluxo, console tecnico, Cup e comportamento por perfil/authority.
4. Settings refletindo exatamente o que foi escolhido no onboarding.
5. Fontes de trabalho e governance host.
6. Assistente e hub de integracoes.
7. Home operacional para workspace novo.
8. Map/results/work usando dados reais do workspace.
