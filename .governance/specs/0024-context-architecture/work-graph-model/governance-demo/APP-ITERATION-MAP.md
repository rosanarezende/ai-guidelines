...
| 07    | Onboarding - pessoas e papeis      | `/onboarding`                 | Trabalhar por pessoas/times/grupos recebendo papeis, com aceite quando outro sujeito e atribuido. | members + roles + invites                     | `iterado`           | `testado-automatizado` | `testado-automatizado`    | APP-07 ativo agora exercita a etapa do onboarding: lista pessoas/grupos, atribui papel proposto e persiste em Settings. Aceite por pessoa convidada ainda e fluxo dedicado. |
