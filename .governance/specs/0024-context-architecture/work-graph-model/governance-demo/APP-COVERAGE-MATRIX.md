...
| Criar/selecionar workspace          | mapa 02/13/15                          | APP-02, APP-13, APP-14                                    | `blank`, `empty-workspace`, `acme-demo`                                                        | `expected-fail` em UI; entrada/select usam Zod                                                    | Workspace virgem ainda nao sustenta Home/Settings/Console de forma suficiente; demo precisa seguir isolada          | Fechar APP-02 primeiro: workspace vazio, Home limpa, Settings limpa, Console degradado            |
| Navegacao global                    | mapa 03A; QRD-35                       | APP-35                                                    | `empty-workspace`                                                                              | `fixme`; contrato existe e tabela do mapa agora e lintada contra YAML                             | Decisao de barra/menu/itens/subitens ainda pendente; sem isso APP-02 nao fecha como experiencia final               | Fechar QRD-35 antes de implementar APP-02 como UX final                                           |
