...
| Portal/control plane Git-backed     | QRD-36/41; `SPIKE-CONTROL-PLANE-PORTAL.md` | APP-38, APP-39, APP-40, APP-41, SEC-13, ARCH-CP                   | Fixture pura do spike: `acct-rosana`, `acct-business`, `ws-mundo-da-mel`                       | `domain` active: projection sem conteudo/segredo; invite->membership sem authority; snapshot/event-log persistidos; GitHub bridge dry-run | Better Auth esta provado como superficie de endpoints, mas seu DB nativo ainda nao foi configurado; nao ha GitHub App real, email ou produto navegavel | Decidir S1c: Better Auth SQLite/Postgres vs portal file-first para release inicial               |
