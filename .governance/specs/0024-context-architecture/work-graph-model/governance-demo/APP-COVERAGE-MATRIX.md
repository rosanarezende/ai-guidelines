...
| Auth real + TanStack Query scope    | QRD-45; mapa 45                                                                | APP-45                                                            | `workspace-shared-convites`                                                                    | `fixme`; decisao fecha que o app usa Better Auth via Next.js, nao TanStack Start; TanStack Query segue como server-state por workspace/sourceRevision                                                                                                                                                                                                                                                      | Falta montar `/api/auth/[...all]`, `auth-client`, schema de session scope e invalidation/clear de queries em login/logout/accept/switch                                                                                                           | Fechar Zod/modelagem/testes de auth/session/cache antes de qualquer tela nova de auth real                                              |
...
4. **APP-45** — Better Auth + TanStack Query: auth via Next.js, session scope, workspace scope e invalidation/clear de cache antes de telas de auth real.
