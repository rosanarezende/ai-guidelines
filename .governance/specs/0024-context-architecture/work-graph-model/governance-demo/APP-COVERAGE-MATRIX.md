...
| Portal/control plane Git-backed     | QRD-36/41; `SPIKE-CONTROL-PLANE-PORTAL.md` | APP-38, APP-39, APP-40, APP-41, SEC-13, ARCH-CP                   | Fixture pura do spike: `acct-rosana`, `acct-business`, `ws-mundo-da-mel`                       | `domain` active: projection publica sem conteudo/segredo; convite aceito cria membership de portal, nao authority; proposal exige sourceRevision | Better Auth esta provado como superficie de endpoints, mas ainda nao ha DB persistido, GitHub App real, email delivery ou rota de produto navegavel  | Decidir S1b: Better Auth com store real + GitHub App dry-run, ou manter como candidato pendente  |
