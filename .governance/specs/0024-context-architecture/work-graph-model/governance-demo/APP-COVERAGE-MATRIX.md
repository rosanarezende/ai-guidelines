...
| Planejamento de ciclo               | mapa 22                                                                        | APP-22, APP-33                                                    | `workspace-planning-progressivo`                                                               | APP-22 `active`: `/planning` cria objetivo/metrica/target via rota Zod e comando `local.planning.save`; `/results` mostra o target planejado como `sem actual valido` sem inflar outcome                                                                                                                                                                                                                   | APP-33 segue `fixme`: a cadeia completa iniciativa -> intake -> audit ainda nao existe; thesis/opportunity/allocation seguem contexto progressivo futuro                                                                                          | Criar intake/proposal e auditoria da cadeia antes de gates                                                     |
...
| Triagem/matcher                     | mapa 24                                                                        | APP-24                                                            | `workspace-provider-versioned-source`                                                          | APP-24 `active`: `/triage` cria item a partir de dúvida, mostra fates, roda matcher determinístico advisory, exige confirmação humana e registra decisão em `/audit`                                                                                                                                                                                                                                       | Matcher ainda não usa provider real nem intake/proposal; unknowns são determinísticos nesta primeira fatia                                                                                                                                        | Ligar intake real e provider de matcher quando APP-23 nascer                                                   |
