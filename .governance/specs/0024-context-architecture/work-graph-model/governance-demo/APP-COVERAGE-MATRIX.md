...
| Criar/selecionar workspace          | mapa 02/13/15                          | APP-02, APP-13, APP-14                                    | `blank`, `empty-workspace`, `acme-demo`                                                        | APP-02 `active`; APP-13/APP-14 ainda `expected-fail`; entrada/select usam Zod                     | Workspace virgem ja cria e isola dados da demo; falta aprofundar Home de workspace parcial e demo switcher          | Proxima fatia: Governance Host; depois APP-13/APP-14 para completar Home e alternancia demo       |
...
3. **APP-13 / APP-14** — Home de workspace parcial e alternancia demo/real sem vazamento.
4. **APP-09 / APP-18 / APP-21 / CONS-02** — fontes de trabalho com sourceTrust compreensivel.
5. **APP-05 / APP-06 / APP-15 / CONS-01** — perfil, regra de acumulo e Settings coerentes.
6. **APP-07 / APP-16 / SEC-11 / SEC-12** — pessoas, grupos, convites, aceite de membership, aceite de papeis e authority efetiva na UI.
7. **APP-28 / APP-29** — `/results` e `/map` sobre demo/read-model com visualizacao real.
8. **INT-01..03** — hub de integracoes read-only, depois GitHub work-source.
9. **CUP-01 / CUP-02** — Cup deterministic C0/C1 sem provider externo.
