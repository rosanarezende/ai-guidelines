...
| Pessoas, times e papeis             | mapa 07/16                             | APP-07, APP-16; SEC-11, SEC-12                                    | `workspace-groups-teams`, `workspace-shared-convites`, `workspace-authority-personas`          | UI de Settings `active`; authority `active` em `domain`; rotas mutaveis usam Zod                  | Fluxo visual humano do onboarding de pessoas ainda nao foi validado; aceite via pessoa convidada ainda precisa de tela/fluxo dedicado                | Validar onboarding visual e depois aprofundar aceite real por conta convidada                    |
...
| Settings como espelho do onboarding | mapa 15/16/18/19/20                    | APP-15, APP-16, APP-18, APP-19, APP-20, CONS-01, CONS-02, CONS-03 | `workspace-compact-policy`, `workspace-shared-convites`, `workspace-provider-versioned-source` | Perfil, pessoas/papeis e fontes `active`; assistant/integracoes seguem `fixme`                    | Settings ja espelha perfil/regra de acumulo, pessoas/papeis e fontes; ainda falta assistant e integracoes dedicadas                                  | Proxima ativacao: assistant ou results/map, conforme prioridade de produto                       |
...
4. **APP-07 / APP-16 / SEC-11 / SEC-12** — pessoas, grupos, convites, papeis propostos e authority efetiva na UI. **Feito no Settings; falta validacao visual humana do onboarding.**
