...
| Onboarding perfil/responsabilidades | mapa 05/06                             | APP-05, APP-06, CONS-01                                   | `empty-workspace`, `workspace-compact-policy`                                                  | `active` em `ui-e2e`; perfil salva via rota Zod e aparece igual em Onboarding, Home e Settings    | Ainda falta validacao visual humana fina da copy; pessoas/papeis continuam em contrato proprio                                                       | Seguir para APP-07/APP-16 quando a tela de pessoas/papeis for priorizada                         |
...
| Settings como espelho do onboarding | mapa 15/18/19/20                       | APP-15, APP-18, APP-19, APP-20, CONS-01, CONS-02, CONS-03 | `workspace-compact-policy`, `workspace-provider-versioned-source`                              | Perfil e fontes `active`; assistant/integracoes seguem `fixme`                                    | Settings ja espelha perfil/regra de acumulo e fontes; ainda falta assistant e integracoes dedicadas                                                  | Proxima ativacao: pessoas/papeis ou assistant, conforme prioridade de produto                    |
