...
| Governance host                     | mapa 08/17                             | APP-08, APP-17, APP-34                                    | `workspace-sem-host`, `workspace-host-local`, `workspace-host-embutido`                        | `expected-fail`; fit-check/link/create/sandbox usam Zod                                           | A UI ainda nao fecha escolha, fit-check, scaffold/link e consequencia no console                                    | Prioridade estrutural junto de APP-02; sem host o workspace real fica degradado                   |
...
3. **APP-08 / APP-17 / APP-34** — governance host escolhido, fit-check, scaffold/link e console degradado/habilitado.
4. **APP-13 / APP-14** — Home de workspace parcial e alternancia demo/real sem vazamento.
