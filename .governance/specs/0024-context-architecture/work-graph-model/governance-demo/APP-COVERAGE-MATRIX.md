...
| Work/execucao                       | mapa 26                                                                        | APP-26                                                            | `acme-demo`                                                                                    | APP-26 `expected-fail`: rota `/work` e read-model existem, mas o contrato ainda espera lista de repo-work, filtro de bloqueados e painel de evidencia que nao estao completos                                                                                                                                                                                                                              | Workflow operacional humano ainda nao fecha: falta evidencia de work, filtros e acoes governadas visiveis                                                                                                                                         | Primeira lista operacional com TanStack Table + MUI, painel de evidencia e actions dry-run                     |
| Contratos                           | mapa 27/29/31                                                                  | APP-27                                                            | `acme-demo`                                                                                    | APP-27 `expected-fail`; rota placeholder existe, mas contrato ainda espera tela de contrato real                                                                                                                                                                                                                                                                                                           | Contract graph existe em read-model, mas tela de contrato ainda nao                                                                                                                                                                               | Tela read-only de contrato, consumers, revision, contention e linked intents                                   |
