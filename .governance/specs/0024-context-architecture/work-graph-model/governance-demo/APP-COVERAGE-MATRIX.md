...
| Pessoas, times e papeis             | mapa 07/16                             | APP-07, APP-16; SEC-11, SEC-12                                    | `workspace-groups-teams`, `workspace-shared-convites`, `workspace-authority-personas`          | Onboarding e Settings `active`; authority `active` em `domain`; rotas mutaveis usam Zod           | Aceite via pessoa convidada ainda precisa de tela/fluxo dedicado                                                                                     | Aprofundar aceite real por conta convidada e fluxos por authority                                |
