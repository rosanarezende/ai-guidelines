...
| Portal/control plane Git-backed     | QRD-36/41/42; `SPIKE-CONTROL-PLANE-PORTAL.md`; `PORTAL-DELIVERY-ROADMAP.md` | APP-38, APP-39, APP-40, APP-41, SEC-13, ARCH-CP                   | Fixture pura do spike: `acct-rosana`, `acct-business`, `ws-mundo-da-mel`                       | `domain` active: projection sem conteudo/segredo; invite->membership sem authority; snapshot/event-log persistidos; GitHub bridge dry-run; S1c cobre SQLite/PostgreSQL/Neo4j; S1d/S1e executam Better Auth HTTP real em SQLite | Better Auth esta provado como superficie de endpoints e SQLite real incluindo convite/aceite; falta provar uso compartilhado em PostgreSQL live, governance host Git-backed real/sandbox, email e produto navegavel | Ordem decidida: S1f PostgreSQL live compartilhado -> S1g Git-backed bridge real/sandbox -> S1h matriz de custo/hospedagem; Neo4j segue como read-model |
