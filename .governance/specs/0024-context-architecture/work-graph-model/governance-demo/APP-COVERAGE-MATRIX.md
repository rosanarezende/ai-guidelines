...
| Auditoria                           | mapa 31                                                                        | APP-31, APP-33, SEC-08                                            | `acme-demo`, `workspace-planning-progressivo`                                                  | APP-31 `active`: `/audit` mostra decisões, outcomes, revisions e exceções/break-glass derivadas com actor, authority, reason, ttl/review e sourceRevision                                                                                                                                                                                                                                                  | Ainda é read-only; APP-33 segue `fixme` para cadeia completa planejamento -> audit                                                                                                                                                                | Ligar eventos reais do host e links de origem quando Planning/Intake/Gate forem ativados                       |
