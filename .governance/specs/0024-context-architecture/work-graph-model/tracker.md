...
8. ⬜ **Generalizar outcome/operacional** — segundo outcome real + bucket operacional sem intent planejada.
9. ⬜ **Re-validação independente (Claude Code/Fable 5 + owner)** — re-percorrer as jornadas big/mid/trio/solo/ciclo anual com o SSOT limpo e a v3 física.
10. ⬜ **Selo do PR #45** — reconciliar PR body/tasks/state da spec + Ready/Human Gate quando a owner decidir.
