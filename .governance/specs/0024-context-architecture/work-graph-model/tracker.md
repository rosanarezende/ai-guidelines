...
- **A app** (`_org-simulation-v3/_apps/governance-next`): superfície React/Next + Material UI sobre a runtime v3; faz dry-run/execute por comando governado e não edita YAML direto. É **projeção operacional**, não o modelo.
