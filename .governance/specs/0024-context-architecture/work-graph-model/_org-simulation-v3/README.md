...
- **Locale versionado:** strings centrais de produto ficam em `_apps/governance-next/locales/pt-br.json`, consumidas pelo helper `lib/i18n.ts`. Backend/domínio deve evoluir para emitir `messageKey` + `params`, não frases soltas.
