...
window.MODEL = {
  ...
  flowExplorer: {
    ...
    reviewRule:
      "review EXTERNO nunca se escolhe — DERIVA: (a) peça em repo de OUTRO time → review do dono do repo · (b) mudança de contrato → review do owner do contrato + consumidores avisados · (c) revisão com quebra → além do review, abre a janela. Impacta PRAZO: os reviews externos aparecem no plano da intent DESDE o breakdown (combinados com os stakeholders, não descobertos no meio)",
    depsRule:
