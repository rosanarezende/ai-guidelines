...
// chips de confiança/risco, evidência, próximo passo, CTA, tooltip com o
// detalhe completo e estados visuais de seleção/foco (dimming da vizinhança).
...
export const CONFIDENCE_COLOR: Record<string, "success" | "warning" | "error" | "default"> = {
  verified: "success",
  pending: "warning",
  "no-evidence": "default",
