        ...
        {PROFILE_OPTIONS.map((option) => {
          ...
          return (
            <OptionCard
              key={option.id}
              selected={selected}
              onClick={() => selectManualProfile(option.id)}
            >
