...
- [x] **Checkpoint 2.2b** — **correção da fronteira mecânica (achado Codex no PR #33)**: extração de gatilhos-base (`on: [pull_request, push]`) + suporte declarativo a produtores externos, prevenindo órfãos de evento absoluto sem criar um workflow engine. Parado no Technical Audit Gate.
