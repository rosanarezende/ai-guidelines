...
- [ ] **Checkpoint 3** — GG-0003 Consistency Projection Check (mecânico, lista fixa de marcadores). **PR próprio _stacked_.** **Nasce dogfoodando o modelo de revisão-como-artefato (2.4).** _(dep: Checkpoint 2.4)_
