...
- [ ] **Checkpoint 2.3** — **Governance Topology as Data**: transformar topologia em SSOT no `state.yml` e resolver ambiguidade no CI de governança. **PR próprio _stacked_.** _(dep: Checkpoint 2.2b)_
- [ ] **Checkpoint 3** — GG-0003 Consistency Projection Check (mecânico, lista fixa de marcadores). **PR próprio _stacked_.** _(dep: Checkpoint 2.3)_
