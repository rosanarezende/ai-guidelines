...
- [ ] **Checkpoint 3** — GG-0003 Consistency Projection Check (mecânico, lista fixa de marcadores). **PR próprio _stacked_.** **Nasce dogfoodando a revisão-como-artefato (2.4/2.4a).** _(dep: Checkpoint 2.4a)_
