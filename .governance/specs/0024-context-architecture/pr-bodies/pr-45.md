...
O valor atual do PR fica focado no framework: artifact taxonomy, model-review contract, research index, PR/body governance, script contracts, mapa da Spec 0024, e preservação auditável da trilha que originou Guilda.
