...
- Locale versionado e colocalizado em `_org-simulation-v3/_apps/governance-next/app/{features,ui}/**/locales/pt-br.json`; novas telas devem consumir strings de produto no menor dono estável da copy (view/step/section/componente/subdomínio/shell).
