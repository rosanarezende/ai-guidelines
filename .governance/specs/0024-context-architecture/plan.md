...
**Ordem de valor:** Checkpoint 1 ✅ → 2 ✅ → 2.1 ✅ → 2.1a ✅ → **2.2 (corrige classe `guardrails` órfão; precede o 3)** → (3 consistência + 4A/4B proveniência: barreiras novas **antes** da migração) → 5 + 6 → **7 (o crítico, protegido)** → 9/10 → 11A/B/C → 8/12 (flex).
