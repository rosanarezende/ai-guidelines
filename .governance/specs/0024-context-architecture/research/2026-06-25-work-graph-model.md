...
- 🔵 **Formato do q/r/d (insight owner 2026-06-29):** o molde de _workbench_ usado na modelagem do manifesto — **pergunta → opções → prós/contras → recomendação → decisão** — validou-se como bom formato pro q/r/d. Dobrar nos templates de deliberação quando revisitá-los (a `research.md` carrega as opções+prós/contras; a `decision.md` carrega a escolha+porquê). _(exemplo vivo: o workbench do shape do manifesto.)_
