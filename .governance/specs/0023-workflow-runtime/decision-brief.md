...
> **Origem:** investigação dedicada em [`research-library/architecture/2026-05-19-lifecycle-architecture.md`](../research-library/architecture/2026-05-19-lifecycle-architecture.md) (consolidada de `research/` local no fechamento, [DEC-0023-O01]) — fechada em 299 linhas (dentro do cap absoluto 300). Identificou gap estrutural entre lifecycle cravado em Bloco D/E (spec-centric) e taxonomy MECE da Spec 0021 (7 pilares). Research convergiu em **invariantes universais leves** (accountability + traceability + outcome registration) + **lifecycle intent categories** (5 eixos de leitura: decision/learning/execution/operational-response/maintenance) + **runtime taxonomy-aware sem orchestration engine** + **enforcement universal leve**.
>
