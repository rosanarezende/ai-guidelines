...
| `build:rules`             | `node cli/governance/monolith/rules-builder.mjs`                                                                                                                                                                                                                                                                                                                                                        | Setup inicial / build |        sim         | `script`, `hook`              | Gera rules.json, catalogo e ledger derivado.                           |
...
| `active-specs:check`      | `yarn build && node cli/active-specs-check.mjs`                                                                                                                                                                                                                                                                                                                                                         | Guards de governanca  |        sim         | `script`                      | Verifica coerencia da projection specs/active.yml.                     |
...
| `runtime-bootstrap:sync`  | `node cli/governance/runtime-bootstrap.mjs sync`                                                                                                                                                                                                                                                                                                                                                        | Guards de governanca  |        sim         | `human`, `hook`               | Sincroniza o stub runtime do AGENTS.md.                                |
| `runtime-bootstrap:check` | `node cli/governance/runtime-bootstrap.mjs check`                                                                                                                                                                                                                                                                                                                                                       | Guards de governanca  |        nao         | `script`                      | Falha se AGENTS.md divergir do stub runtime governado.                 |
...
node .yarn/releases/yarn-4.1.1.cjs runtime-bootstrap:sync
