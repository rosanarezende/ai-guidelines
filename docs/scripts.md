...
| `test:unit`            | `node --test cli/**/*.test.mjs cli/**/**/*.test.mjs tests/**/*.test.mjs` (suite mjs) |        não         | pre-commit hook (passo 3); dentro de `test`                                                      |
...
| `test:coverage`        | mjs com `--experimental-test-coverage` + `jest --coverage`                           |        não         | manual / análise ad-hoc                                                                          |
