...
| **GR-0006**  | No autonomous dependency installation (Anti-Slopsquatting) | `universal` | `security`        | [Ver](global-rules.md#gr0006)                  |
...
| **OPT-0101** | BDD Test Structure                                         | `opt-in`    | `correctness`     | [Ver](opt-in/methodologies/bdd-en.md#opt0101)  |
| **OPT-0201** | Estrutura de Teste BDD                                     | `opt-in`    | `correctness`     | [Ver](opt-in/methodologies/bdd-pt.md#opt0201)  |
| **OPT-0301** | Quality Gates (Checklist)                                  | `opt-in`    | `correctness`     | [Ver](opt-in/quality/quality-gates.md#opt0301) |
| **OPT-0401** | Strict TDD Cycle                                           | `opt-in`    | `correctness`     | [Ver](opt-in/methodologies/tdd-en.md#opt0401)  |
| **OPT-0501** | Ciclo TDD Estrito                                          | `opt-in`    | `correctness`     | [Ver](opt-in/methodologies/tdd-pt.md#opt0501)  |
