...
| `.governance/specs/{roadmap/,research-library/,research-index.md}` | Estrutura canônica de fechamento (ADR 0019): `roadmap/` (backlog+historico), `research-library/<domínio>/` (pesquisas consolidadas) e `research-index.md`. Provisionada pelo bootstrap (`[DEC-0023-O01]`)                     | Ativo (canônico)                            |
