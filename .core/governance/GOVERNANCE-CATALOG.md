...
**Por que MECE.** A taxonomia define classes mutuamente exclusivas (`spec` ≠ `incident` ≠ `experiment`) e coletivamente exaustivas (todo trabalho de valor cabe em um dos 7). Quando um item não cabe, a resposta correta é abrir ADR — não criar pilar novo de oportunidade. Critério formalizado em `.core/governance/adrs/0001-taxonomy-mece-pillars.md`.
...
| `.core/governance/adrs/`               | **Lar canônico** das ADRs globais (0001–0005 hoje; legadas migram em 4.B.5)                                                                   | Ativo (transição)                           |
...
| `.core/process/`                       | Constituição operacional viva — `spec-foundation.md` (renomeado em 4.B.1)                                                                     | Ativo                                       |
...
| `adrs/`                                | **Legado** — ADRs 0003–0009. Migram para `.core/governance/adrs/` em **4.B.5**                                                                | Depreciado                                  |
...
| Qual o processo de abertura e ciclo de vida?          | `.core/process/spec-foundation.md` (renomeado em 4.B.1)                                 |
...
| :-------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------- | :-------------------------- |
| ADRs legadas em `/adrs/` (0003–0009) coabitam com `.core/governance/adrs/` (0001–0005); numeração colide.       | Dois lares ativos.                                                     | Lar único `.core/governance/adrs/`; legadas renumeradas 0010–0014; auditoria a/b/c (reescrever / rebaixar / superseded) por ADR. | **4.B.4 + 4.B.5**           |
| `.core/process/spec-foundation.md` tem nome legado (gera dissonância pós-7-pilares).                            | Nome ainda é `spec-foundation`.                                        | Renome alinhado a "governança" (`governance-foundation.md` ou equivalente — decidido em 4.B.1).                                  | **4.B.1**                   |
