...
| **`LIVING_DOCS_*` errors**       | Família de códigos estáveis emitidos pelo schema guard: `LIVING_DOCS_MISSING_FIELD`, `LIVING_DOCS_INVALID_RULE_ID`, `LIVING_DOCS_INVALID_COVERAGE_STATE`, `LIVING_DOCS_INVALID_SOURCE`, `LIVING_DOCS_INVALID_TAGS`, `LIVING_DOCS_INVALID_ENTRIES`, `LIVING_DOCS_INVALID_SCHEMA_VERSION`, `LIVING_DOCS_DUPLICATE_RULE_ID`, `LIVING_DOCS_BYPASS_MALFORMED`, `LIVING_DOCS_BYPASS_REQUIRES_DEPRECATED`. Mensagens podem evoluir; códigos não. |
